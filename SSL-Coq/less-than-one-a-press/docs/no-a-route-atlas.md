...
| 10A | Direct Area-2 gates | 🎮 [Ground-pound startup while the elevator or another support moves](#route-rank-10a) | Low; the height window remains, but checked elevator jolts, nearby hanging, rollout endings and the ordinary slide kick with its bounce do not supply entry; a harder fall or changed support and a useful sideways effect remain open | 2–5% |
